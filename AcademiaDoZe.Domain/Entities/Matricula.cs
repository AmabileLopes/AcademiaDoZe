...
namespace AcademiaDoZe.Domain.Entities
{
    public class Matricula : Entity
    {
        ...
        private Matricula(int id, Aluno alunoMatricula, EMatriculaPlano plano, DateOnly dataInicio, DateOnly dataFim, string objetivo, EMatriculaRestricoes restricoesMedicas, Arquivo laudoMedico, string observacoesRestricoes = "")
        : base(id)
        {
            Id = id;
        ...
        public static Matricula Criar(int id, Aluno alunoMatricula, EMatriculaPlano plano, DateOnly dataInicio, DateOnly dataFim, string objetivo, EMatriculaRestricoes restricoesMedicas, Arquivo laudoMedico, string
