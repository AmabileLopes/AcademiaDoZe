...
namespace AcademiaDoZe.Infrastructure.Repositories
{
    ...
    public class AlunoRepository : BaseRepository<Aluno>, IAlunoRepository
    {
        ...
        // Implementação dos métodos específicos do repositório de Aluno aqui
        ...
        public override async Task<Aluno> Adicionar(Aluno entity)
        {
            try
            {
                ...
                ? $"INSERT INTO {TableName} (nome, cpf, nascimento, telefone, email, logradouro_id, numero, complemento, senha, foto) " +
                  "OUTPUT INSERTED.id_aluno " +
                  "VALUES (@Nome, @cpf, @nascimento, @telefone, @email, @logradouroId, @numero, @complemento, @senha, @foto);"
                : $"INSERT INTO {TableName} (nome, cpf, data_nascimento, telefone, email, logradouro_id, numero, complemento, senha, foto) " +
                    "VALUES (@Nome, @cpf, @nascimento, @telefone, @email, @logradouroId, @numero, @complemento, @senha, @foto); " +
            ...
            {
                throw new InvalidOperationException("Erro ao adicionar aluno.", ex);
            }
        }
        ...
        protected override async Task<Aluno> MapAsync(DbDataReader reader)
        {
            try
            {
                ...
                // Cria o objeto Ãluno usando o método de fábrica
            ...
            catch (Exception ex) { throw new InvalidOperationException($"erro ao mapear dados do aluno", ex); }
        }
    }
